...
I've spent considerable time developing the [ONI (Open Neurosecurity Interoperability) framework](https://github.com/qinnovates/qif) for neural security — exploring coherence breaches, the Scale-Frequency Invariant, and threats to brain-computer interfaces. I know enough about quantum mechanics to see tantalizing connections. But do I know enough to know where I'm wrong?
...
In the [ONI framework](https://github.com/qinnovates/qif/blob/main/MAIN/publications/0-oni-framework/Blog-ONI_Framework.md), we call this the **liminal phase** — the state between states, where the system is neither here nor there. And it's governed by physics I'll return to shortly.
